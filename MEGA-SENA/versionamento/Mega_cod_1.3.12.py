...
def construir_modelo():
    modelo = Sequential([
        ...
        Dense(6, activation='linear')  # Saída final
    ])
...
def treinar_modelo_basico(modelo, entradas, saidas, dados):
    ...
    #saidas_normalizadas = saidas / 60.0
    ...
    for i in range(len(entradas)):
        ...
        historico = modelo.fit(entradas_normalizadas, saidas, batch_size=16, epochs=200, callbacks=[early_stopping])
